\begin{titlepage}
	...
	\begin{center}
		...
		\textsc{\huge \bfseries Rapport de projet tuteuré}\\[1cm]

		\emph{Apprenti: }\\Julien \textsc{Rosset}\\[1cm]

		\fbox{\parbox[top][2cm][c]{\textwidth}{\begin{center}\Huge \bfseries Réécriture d'un module utilisant un\\\'Echange de Données Informatisé \end{center}}}\\[1cm]
